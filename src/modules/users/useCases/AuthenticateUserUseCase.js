...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user, isPasswordCorrect, JWT_SECRET, token, TokenResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        token = (0, jsonwebtoken_1.sign)({}, JWT_SECRET, {
                            subject: user.id,
                            expiresIn: "1d"
                        });
                        TokenResponse = {
                        ...
                        return [2 /*return*/, { TokenResponse: TokenResponse }];
                }
            });
        });
    };
